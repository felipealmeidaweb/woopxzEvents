<template>
  <div class="home">
    <h1 class="text-white">Veja as últimas festas</h1>
    <div class="parties-container">
        <div v-for="(party, index) in parties" :key="index" class="party-container">
            ...
            <router-link :to="`/party/${party._id}`" class="party-title text-white">{{ party.title }}</router-link>
            <p class="party-date text-white">Data: {{ party.partyDate }}</p>
